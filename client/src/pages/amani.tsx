      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-xl text-slate-600">Building reliable health surveillance systems where infrastructure fails</p>
            ...
            <CardContent className="p-6 space-y-4">
              ...
              <div className="space-y-4 text-slate-700">
                ...
                <div className="bg-slate-100 p-4 rounded">
                  <p className="text-slate-800 font-semibold mb-2">The core challenge:</p>
          ...
          <Card className="bg-slate-50 border-terminal-green">
            <CardContent className="p-6">
              ...
              <div className="space-y-4">
                <p className="text-slate-700">Our multidisciplinary team brought together expertise in engineering, data science, design, and community work with displaced families:</p>
          ...
          <Card className="bg-slate-50 border-terminal-green">
            <CardContent className="p-6">
              ...
              <p className="text-slate-700 mb-4">As the technical lead for AI systems and health data architecture, I focused on designing workflows and system components that would work under real-world humanitarian constraints.</p>
              <div className="space-y-6">
                ...
                <div className="bg-terminal-green/10 border border-terminal-green p-4 rounded mt-4">
                  <p className="text-slate-700 text-sm italic"><strong className="text-terminal-green">The guiding principle:</strong> Build a system that's reliable under constraints, not perfect under ideal conditions. Every design decision asked: "Will this work on a 3-year-old Android phone with sporadic 2G connectivity in a refugee camp?"</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="bg-slate-100 p-4 rounded space-y-3">
                    <div>
                      <p className="text-terminal-green font-semibold">Mobile Application (React Native)</p>
                      <ol className="list-decimal list-inside mt-2 space-y-1 text-slate-600 text-sm">
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="border-l-2 border-terminal-green pl-4">
                      <h4 className="text-slate-800 font-semibold mb-2">On-Device 3D Scene Reconstruction</h4>
                      <p className="text-slate-600 text-sm mb-2">Using Gaussian splatting combined with Visual-Inertial Odometry (VIO), the system enables users to create local 3D scenes entirely on-device.</p>
                    ...
                    <div className="border-l-2 border-terminal-green pl-4">
                      <h4 className="text-slate-800 font-semibold mb-2">Edge-Efficient Computer Vision</h4>
                    ...
                    <div className="border-l-2 border-terminal-green pl-4">
                      <h4 className="text-slate-800 font-semibold mb-2">Human-in-the-Loop Validation</h4>
                      <p className="text-slate-600 text-sm mb-2">AI suggests hazard classification, frontline health workers confirm, system escalates with audit trail.</p>
                      <p className="text-slate-500 text-sm">This design balances automation with community expertise, builds trust with vulnerable populations, and mirrors clinical AI validation workflows used in diagnostic tools.</p>
                    </div>
                    <div className="border-l-2 border-terminal-green pl-4">
                      <h4 className="text-slate-800 font-semibold mb-2">Privacy-by-Design Architecture</h4>
                      <ul className="list-disc list-inside space-y-1 text-slate-600 text-sm">
            ...
            <CardContent className="p-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <ol className="list-decimal list-inside space-y-2 text-slate-500 text-sm">
              ...
              <div className="mt-6 bg-terminal-green/10 border border-terminal-green p-4 rounded">
                <p className="text-slate-700 text-sm"><strong className="text-terminal-green">Impact:</strong> Compress response time from days to hours. Enable community-driven early warning systems that respect local knowledge while scaling organizational capacity.</p>
              </div>
            </CardContent>
          </Card>
          <Card className="bg-slate-50 border-terminal-green">
            <CardContent className="p-6">
              ...
              <div className="space-y-6">
                <div className="border-l-2 border-terminal-green pl-4">
                  ...
                  <p className="text-slate-600 text-sm mb-2">Intermittent connectivity in refugee camps made cloud-dependent systems unreliable. Processing on-device meant:</p>
                  <ul className="list-disc list-inside space-y-1 text-slate-500 text-sm">
                ...
                <div className="border-l-2 border-terminal-green pl-4">
                  ...
                  <p className="text-slate-600 text-sm mb-2">Frontline health workers have contextual knowledge AI cannot capture:</p>
                  <ul className="list-disc list-inside space-y-1 text-slate-500 text-sm">
                  ...
                  <p className="text-slate-500 text-sm mt-2">Our system augments their expertise rather than replacing it, similar to how clinical diagnostic AI assists rather than replaces physicians.</p>
                </div>
                <div className="border-l-2 border-terminal-green pl-4">
          ...
          <Card className="bg-slate-50 border-terminal-green">
            <CardContent className="p-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h3 className="text-slate-800 font-semibold mb-3">Mobile & Frontend</h3>
                  <ul className="space-y-1 text-slate-600 text-sm">
                ...
                <div>
                  <h3 className="text-slate-800 font-semibold mb-3">AI & Computer Vision</h3>
                  <ul className="space-y-1 text-slate-600 text-sm">
                ...
                <div>
                  <h3 className="text-slate-800 font-semibold mb-3">Backend & Infrastructure</h3>
                  <ul className="space-y-1 text-slate-600 text-sm">
                ...
                <div>
                  <h3 className="text-slate-800 font-semibold mb-3">Public Health Integration</h3>
                  <ul className="space-y-1 text-slate-600 text-sm">
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-6">
                <div className="bg-terminal-green/10 border border-terminal-green p-4 rounded">
                  ...
                  <p className="text-slate-600 text-sm">Our team advanced to the finalist round, presenting AMANI to healthcare innovators, public health experts, and impact investors.</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="border-l-2 border-terminal-green/50 pl-4">
                      <h4 className="text-slate-800 font-semibold mb-1">Constraints Drive Better Design</h4>
                      <p className="text-slate-500 text-sm">Building for low bandwidth, older devices, and vulnerable users forced simplicity, reliability, and privacy-first architecture. These constraints produced better design decisions than optimizing for ideal conditions.</p>
                    </div>
                    <div className="border-l-2 border-terminal-green/50 pl-4">
                      <h4 className="text-slate-800 font-semibold mb-1">Automation Must Augment Human Expertise</h4>
                      <p className="text-slate-500 text-sm">Our human-in-the-loop approach respected frontline workers' knowledge while scaling their capacity. This principle applies across health tech applications, from diagnostic AI to genomic analysis tools to BCI systems.</p>
                    </div>
                    <div className="border-l-2 border-terminal-green/50 pl-4">
                      <h4 className="text-slate-800 font-semibold mb-1">Deployment Readiness From Day One</h4>
                      <p className="text-slate-500 text-sm">AMANI wasn't designed as a prototype—every component considered real-world implementation with NGO partners. This meant planning for training, rollout, sustainability, and community adoption throughout the design process.</p>
                    </div>
                    <div className="border-l-2 border-terminal-green/50 pl-4">
                      <h4 className="text-slate-800 font-semibold mb-1">Privacy and Trust Are Foundational</h4>
                      <p className="text-slate-500 text-sm">For vulnerable populations, data privacy isn't a compliance requirement—it's central to whether the system gets used at all. This shaped every technical architecture decision.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <Card className="bg-slate-50 border-terminal-green">
            <CardContent className="p-6">
              ...
              <div className="space-y-4">
                <div className="border-l-2 border-terminal-green pl-4">
                  <h3 className="text-slate-800 font-semibold mb-2">Field Pilot Deployment</h3>
                  <p className="text-slate-600 text-sm mb-2">Partner with MSF, UNHCR, or UN WASH Cluster for real refugee camp deployment. Collect metrics on:</p>
                  <ul className="list-disc list-inside space-y-1 text-slate-500 text-sm">
                ...
                <div className="border-l-2 border-terminal-green pl-4">
                  <h3 className="text-slate-800 font-semibold mb-2">Expanded Computer Vision Capabilities</h3>
                  <p className="text-slate-600 text-sm mb-2">Future iterations could:</p>
                  <ul className="list-disc list-inside space-y-1 text-slate-500 text-sm">
                ...
                <div className="border-l-2 border-terminal-green pl-4">
                  <h3 className="text-slate-800 font-semibold mb-2">Continuous Learning Pipeline</h3>
                  <p className="text-slate-500 text-sm">Use confirmed field reports as training data to improve AI suggestions over time, creating a feedback loop where better AI leads to less manual review and faster response.</p>
                </div>
                <div className="border-l-2 border-terminal-green pl-4">
                  <h3 className="text-slate-800 font-semibold mb-2">Integration with Existing Health Systems</h3>
                  <p className="text-slate-500 text-sm">Connect AMANI to humanitarian early-warning systems (WHO Disease Outbreak News, UNHCR health dashboards) to enable proactive outbreak prevention at regional scale.</p>
                </div>
              </div>
            </CardContent>
          </Card>
