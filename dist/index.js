...
app.use(helmet({
  contentSecurityPolicy: {
    ...
    directives: {
      ...
      imgSrc: ["'self'", "data:"],
      scriptSrc: app.get("env") === "development" ? ["'self'", "'unsafe-inline'", "'unsafe-eval'"] : ["'self'"],
      frameAncestors: ["'none'"]
    }
  },
  hsts: app.get("env") === "production" ? { maxAge: 31536e3, includeSubDomains: true, preload: true } : false
}));
